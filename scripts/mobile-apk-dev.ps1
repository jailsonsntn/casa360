...
# Resolve SDK path from env or common default for this machine.
...
# Persist sdk.dir expected by Gradle.
"sdk.dir=$sdkPath" | Set-Content -Path $localPropertiesPath -Encoding ASCII

# Prefer Android Studio bundled JDK (compatible with AGP/Gradle setup).
...
Write-Host 'Executando build de APK debug...'
